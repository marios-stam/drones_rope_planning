#include "../include/ompl_example_2d/stlloader.hpp"
...
namespace stlloader
{
    ...
    {
        // std::cout << "Comparing:" << a.x << " " << a.y << " " << a.z << std::endl;
        // std::cout << "Comparing:" << b.x << " " << b.y << " " << b.z << std::endl;
        float threshold = 0.001;
        float abs_dx = std::abs(a.x - b.x);
        float abs_dy = std::abs(a.y - b.y);
        float abs_dz = std::abs(a.z - b.z);
        // std::cout << "abs_dx:" << abs_dx << " abs_dy:" << abs_dy << " abs_dz:" << abs_dz << std::endl;
        bool result = (abs_dx < threshold && abs_dy < threshold && abs_dz < threshold);
        // std::cout << "result:" << result << std::endl;
        return result;
    }

    bool vertices_smaller(const stlloader::Vertex &a, const stlloader::Vertex &b) { return a.x < b.x || a.y < b.y || a.z < b.z; }

    bool vertices_larger(const stlloader::Vertex &a, const stlloader::Vertex &b) { return a.x > b.x || a.y > b.y || a.z > b.z; }
    ...
    std::ostream &operator<<(std::ostream &os, const Normal &n) { return os << n.x << ' ' << n.y << ' ' << n.z; }
